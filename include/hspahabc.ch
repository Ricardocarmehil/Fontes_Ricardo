	...
	#else
		#define STR0001 "Cadastro de Fatores de Risco"
		#define STR0002 "Este fator de risco não pode ser excluído"
		#define STR0003 "Controle de Integridade"
		#define STR0004 "Existe este fator de risco no cadastro de Notificacao. Impossivel Exclui-la!"
