	...
	#else
		#define STR0001 "Interconsultas"
		#define STR0002 "Convênio com Tipo de Pagamento Médico Inválido! Impossível gerar Interconsultas!"
		#define STR0003 "Atenção"
		#define STR0004 "Selecione onde deseja alterar CRM. Atendimento, Exames ou Procedimentos"
		#define STR0005 "Registro de atendimento invalido"
		#define STR0006 "Especialidade invalida"
		#define STR0007 "CRM invalido. (GBJ)"
		#define STR0008 "CRM invalido. (SRA)"
		#define STR0009 "Nao e permitido excluir interconsultas"
	#endif
#endif
