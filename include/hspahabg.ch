	...
	#else
		#define STR0001 "Cadastro de Motivo de Cancelamento do Atendimento"
		#define STR0002 "Motivo de Cancelamento do Atendimento cadastrado no Atendimento. Exclusao nao permitida"
