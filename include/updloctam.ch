	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", , "Update UPDLOCTAM" )
		#define STR0002 If( cPaisLoc $ "ANG|PTG", , "Ajuste do tamanho do campo Armazém" )
		#define STR0003 If( cPaisLoc $ "ANG|PTG", , "Atenção: Para que o ajuste possa ser efetuado, NENHUM usuário pode estar utilizando o sistema!" )
		#define STR0004 If( cPaisLoc $ "ANG|PTG", , "3=Ajustar com zeros à esquerda" )
		#define STR0005 If( cPaisLoc $ "ANG|PTG", , "2=Ajustar com brancos à esquerda" )
		#define STR0006 If( cPaisLoc $ "ANG|PTG", , "4=Preencher à esquerda" )
		#define STR0007 If( cPaisLoc $ "ANG|PTG", , "1=Não ajustar" )
		#define STR0008 If( cPaisLoc $ "ANG|PTG", , "5=Preencher à direita" )
		#define STR0009 If( cPaisLoc $ "ANG|PTG", , "O objetivo deste programa de atualização é permitir o ajuste de tamanho do campo Código de Armazém para até seis posições. Note que essa rotina não atualiza campos customizados automaticamente." )
		#define STR0010 If( cPaisLoc $ "ANG|PTG", , "Faça um backup dos dicionários e da base de dados antes da atualização para eventuais falhas no processo!" )
		#define STR0011 If( cPaisLoc $ "ANG|PTG", , "Informe o tamanho desejado e a forma de ajuste das informações já existentes." )
		#define STR0012 If( cPaisLoc $ "ANG|PTG", , "SIGAMAT.EMP com problemas!" )
		#define STR0013 If( cPaisLoc $ "ANG|PTG", , "Ajuste do campo Armazém" )
		#define STR0014 If( cPaisLoc $ "ANG|PTG", , "&Cancelar" )
		#define STR0015 If( cPaisLoc $ "ANG|PTG", , "&Avançar" )
		#define STR0016 If( cPaisLoc $ "ANG|PTG", , "Bem-vindo!" )
		#define STR0017 If( cPaisLoc $ "ANG|PTG", , "Tamanho atual:" )
		#define STR0018 If( cPaisLoc $ "ANG|PTG", , "Tamanho novo:" )
		#define STR0019 If( cPaisLoc $ "ANG|PTG", , "Tipo de ajuste:" )
		#define STR0020 If( cPaisLoc $ "ANG|PTG", , "Preencher com:" )
		#define STR0021 If( cPaisLoc $ "ANG|PTG", , "Atualizações realizadas:" )
		#define STR0022 If( cPaisLoc $ "ANG|PTG", , "Atualizações realizadas:" )
		#define STR0023 If( cPaisLoc $ "ANG|PTG", , " caracter(es)." )
		#define STR0024 If( cPaisLoc $ "ANG|PTG", , "Atenção" )
		#define STR0025 If( cPaisLoc $ "ANG|PTG", , "Você pode inserir até " )
		#define STR0026 If( cPaisLoc $ "ANG|PTG", , "Tem certeza de que deseja continuar?" )
		#define STR0027 If( cPaisLoc $ "ANG|PTG", , "Processamento" )
		#define STR0028 If( cPaisLoc $ "ANG|PTG", , "Execução do ajuste" )
		#define STR0029 If( cPaisLoc $ "ANG|PTG", , "Empresas:" )
		#define STR0030 If( cPaisLoc $ "ANG|PTG", , "Ajuste finalizado!" )
		#define STR0031 If( cPaisLoc $ "ANG|PTG", , "Ajuste das tabelas finalizado!" )
		#define STR0032 If( cPaisLoc $ "ANG|PTG", , "Ajuste finalizado!" )
		#define STR0033 If( cPaisLoc $ "ANG|PTG", , "&Salvar Log" )
		#define STR0034 If( cPaisLoc $ "ANG|PTG", , "&Finalizar" )
		#define STR0035 If( cPaisLoc $ "ANG|PTG", , "SIGAMAT.EMP em uso!" )
		#define STR0036 If( cPaisLoc $ "ANG|PTG", , "Alterando campos da empresa: " )
		#define STR0037 If( cPaisLoc $ "ANG|PTG", , "Aguarde..." )
		#define STR0038 If( cPaisLoc $ "ANG|PTG", , "Aguarde... Iniciando empresa " )
		#define STR0039 If( cPaisLoc $ "ANG|PTG", , " às " )
		#define STR0040 If( cPaisLoc $ "ANG|PTG", , ">> Ajuste iniciado em " )
		#define STR0041 If( cPaisLoc $ "ANG|PTG", , "LOG da atualização do campo Armazém (UPDLOCTAM)" )
		#define STR0042 If( cPaisLoc $ "ANG|PTG", , "Verificando integridade do SX3..." )
		#define STR0043 If( cPaisLoc $ "ANG|PTG", , "Atualizando SX3 (de " )
		#define STR0044 If( cPaisLoc $ "ANG|PTG", , " para " )
		#define STR0045 If( cPaisLoc $ "ANG|PTG", , " posições)..." )
		#define STR0046 If( cPaisLoc $ "ANG|PTG", , "Verificando integridade do SX3..." )
		#define STR0047 If( cPaisLoc $ "ANG|PTG", , "Atualizando SX3 (de " )
		#define STR0048 If( cPaisLoc $ "ANG|PTG", , " para " )
		#define STR0049 If( cPaisLoc $ "ANG|PTG", , " posições)..." )
		#define STR0050 If( cPaisLoc $ "ANG|PTG", , "Verificando estrutura do banco de dados..." )
		#define STR0051 If( cPaisLoc $ "ANG|PTG", , "Atualizando estrutura do banco de dados..." )
		#define STR0052 If( cPaisLoc $ "ANG|PTG", , "Verificando estrutura física dos arquivos:" )
		#define STR0053 If( cPaisLoc $ "ANG|PTG", , "Atualizando estrutura física dos arquivos:" )
		#define STR0054 If( cPaisLoc $ "ANG|PTG", , "Verificando estrutura física do arquivo " )
		#define STR0055 If( cPaisLoc $ "ANG|PTG", , "Atualizando estrutura física do arquivo " )
		#define STR0056 If( cPaisLoc $ "ANG|PTG", , "Ocorreu um erro durante a atualização da tabela: " )
		#define STR0057 If( cPaisLoc $ "ANG|PTG", , "Atenção" )
		#define STR0058 If( cPaisLoc $ "ANG|PTG", , ". Verifique a integridade do dicionário e da tabela." )
		#define STR0059 If( cPaisLoc $ "ANG|PTG", , "&Continuar" )
		#define STR0060 If( cPaisLoc $ "ANG|PTG", , "Ocorreu um erro durante a atualização da tabela: " )
		#define STR0061 If( cPaisLoc $ "ANG|PTG", , "Atualizando conteúdo dos campos..." )
		#define STR0062 If( cPaisLoc $ "ANG|PTG", , "Atualizando conteúdo dos campos..." )
		#define STR0063 If( cPaisLoc $ "ANG|PTG", , "Verificando grupos de perguntas (SX1)..." )
		#define STR0064 If( cPaisLoc $ "ANG|PTG", , " posições)..." )
		#define STR0065 If( cPaisLoc $ "ANG|PTG", , "Atualizando grupos de perguntas (SX1 - de " )
		#define STR0066 If( cPaisLoc $ "ANG|PTG", , " para " )
		#define STR0067 If( cPaisLoc $ "ANG|PTG", , "Verificando grupos de perguntas (SX1)..." )
		#define STR0068 If( cPaisLoc $ "ANG|PTG", , "Atualizando grupos de perguntas (SX1 - de " )
		#define STR0069 If( cPaisLoc $ "ANG|PTG", , " para " )
		#define STR0070 If( cPaisLoc $ "ANG|PTG", , " posições)..." )
		#define STR0071 If( cPaisLoc $ "ANG|PTG", , "Atualizando parâmetros..." )
		#define STR0072 If( cPaisLoc $ "ANG|PTG", , "Atualizando parâmetros..." )
		#define STR0073 If( cPaisLoc $ "ANG|PTG", , "* Ajuste feito nas tabelas da filial " )
		#define STR0074 If( cPaisLoc $ "ANG|PTG", , " / Filial: " )
		#define STR0075 If( cPaisLoc $ "ANG|PTG", , "Empresa: " )
		#define STR0076 If( cPaisLoc $ "ANG|PTG", , "Aguarde... Finalizando ambiente da empresa " )
		#define STR0077 If( cPaisLoc $ "ANG|PTG", , "Aguarde..." )
		#define STR0078 If( cPaisLoc $ "ANG|PTG", , "Arquivos de Log (*.LOG) |*.log|" )
		#define STR0079 If( cPaisLoc $ "ANG|PTG", , "Este LOG foi salvo automaticamente como " )
		#define STR0080 If( cPaisLoc $ "ANG|PTG", , "Ok" )
		#define STR0081 If( cPaisLoc $ "ANG|PTG", , " no diretório dos SXs." )
		#define STR0082 If( cPaisLoc $ "ANG|PTG", , "Ok" )
		#define STR0083 If( cPaisLoc $ "ANG|PTG", , "A extenção '.LOG' foi adicionada ao arquivo, que foi salvo do diretório escolhido (" )
		#define STR0084 If( cPaisLoc $ "ANG|PTG", , "Código de Armazém" )
		#define STR0085 If( cPaisLoc $ "ANG|PTG", , "Atualizando campo " )
		#define STR0086 If( cPaisLoc $ "ANG|PTG", , "Atualizando campo " )
		#define STR0087 If( cPaisLoc $ "ANG|PTG", , "Pergunta não encontrada: " )
		#define STR0088 If( cPaisLoc $ "ANG|PTG", , "Atualizando pergunta " )
		#define STR0089 If( cPaisLoc $ "ANG|PTG", , "Atualizando parâmetro " )
		#define STR0090 If( cPaisLoc $ "ANG|PTG", , "O tamanho do campo não pode ser menor que " )
		#define STR0091 If( cPaisLoc $ "ANG|PTG", , " nem maior que " )
		#define STR0092 If( cPaisLoc $ "ANG|PTG", , "Atenção" )
		#define STR0093 If( cPaisLoc $ "ANG|PTG", , "Não é possível diminuir o tamanho do campo. Especifique um valor maior que o atual." )
	#endif
#endif
